// -*- C++ -*-
//
// Package:   SimpleNtupleEoverPsingleParticle
// Class:     SimpleNtupleEoverPsingleParticle
//
#include "Calibration/EcalCalibNtuple/plugins/SimpleNtupleEoverPsingleParticle.h"
...
SimpleNtupleEoverPsingleParticle::SimpleNtupleEoverPsingleParticle(const edm::ParameterSet& iConfig)
{
  std::cout<< ">>> SimpleNtupleEoverPsingleParticle::SimpleNtupleEoverPsingleParticle begin <<<" << std::endl;
  
    
  // Initialize parameters for cluster corrections
  std::cout<< ">>>>>> SimpleNtupleEoverPsingleParticle::SimpleNtupleEoverPsingleParticle::read parameters <<<" << std::endl;
  InitializeParams(params);
  
  edm::Service<TFileService> fs ;
  outTree_  = fs -> make <TTree>("SimpleNtupleEoverPsingleParticle","SimpleNtupleEoverPsingleParticle"); 
  ...
  reducedrecHitCollection_EB_ = iConfig.getParameter<edm::InputTag>("reducedrecHitCollection_EB");
  reducedrecHitCollection_EE_ = iConfig.getParameter<edm::InputTag>("reducedrecHitCollection_EE");
  reducedrecHitCollection_ES_ = iConfig.getParameter<edm::InputTag>("reducedrecHitCollection_ES");
  ...
  recHitCollection_ES_ = iConfig.getParameter<edm::InputTag>("recHitCollection_ES");
  ...
  particleIsEle_    = iConfig.getUntrackedParameter<bool>("particleIsEle",       false);
  ...
  eventNaiveId_     = 0;
  //  mcAnalysisZW_     = NULL;
  //  mcAnalysisSingleParticle_     = NULL;
  
  
  //---- Initialize tree branches ----
  
  // event variables
  std::cout<< ">>>>>> SimpleNtupleEoverPsingleParticle::SimpleNtupleEoverPsingleParticle::set event branches <<<" << std::endl;
  ...
  outTree_ -> Branch("isEle", &isEle, "isEle/I");
  outTree_ -> Branch("isPho", &isPho, "isPho/I");  
  ...
  // ele1 variables
  std::cout<< ">>>>>> SimpleNtupleEoverPsingleParticle::SimpleNtupleEoverPsingleParticle::set ele1 branches <<<" << std::endl;
  ...
  outTree_ -> Branch("ele1_recHit_ID",             "std::vector<int>",&ele1_recHit_ID);
  outTree_ -> Branch("ele1_recHit_E",              "std::vector<float>",&ele1_recHit_E);
  outTree_ -> Branch("ele1_recHit_time",           "std::vector<float>",&ele1_recHit_time);
  ...
  // ele2 variables
  std::cout<< ">>>>>> SimpleNtupleEoverPsingleParticle::SimpleNtupleEoverPsingleParticle::set ele2 branches <<<" << std::endl;
  ...
  outTree_ -> Branch("ele2_recHit_ID",             "std::vector<int>",&ele2_recHit_ID);
  outTree_ -> Branch("ele2_recHit_E",              "std::vector<float>",&ele2_recHit_E);
  outTree_ -> Branch("ele2_recHit_time",           "std::vector<float>",&ele2_recHit_time);
  ...
  outTree_ -> Branch("ele_nRecHits",&ele_nRecHits,"ele_nRecHits/I");
  outTree_ -> Branch("ele_recHit_ID",             "std::vector<int>",&ele_recHit_ID);
  outTree_ -> Branch("ele_recHit_E",              "std::vector<float>",&ele_recHit_E);
  outTree_ -> Branch("ele_recHit_time",           "std::vector<float>",&ele_recHit_time);
  outTree_ -> Branch("ele_recHit_flag",           "std::vector<int>",  &ele_recHit_flag);
  outTree_ -> Branch("ele_recHit_hashedIndex",    "std::vector<int>",  &ele_recHit_hashedIndex);
  outTree_ -> Branch("ele_recHit_ietaORix",       "std::vector<int>",  &ele_recHit_ietaORix);
  outTree_ -> Branch("ele_recHit_iphiORiy",       "std::vector<int>",  &ele_recHit_iphiORiy);
  outTree_ -> Branch("ele_recHit_zside",          "std::vector<int>",  &ele_recHit_zside);
  outTree_ -> Branch("ele_recHit_laserCorrection","std::vector<float>",&ele_recHit_laserCorrection);
  outTree_ -> Branch("ele_recHit_Alpha",          "std::vector<float>",&ele_recHit_Alpha);
  outTree_ -> Branch("ele_recHit_ICConstant",     "std::vector<float>",&ele_recHit_ICConstant);

  
  // met variables
  std::cout<< ">>>>>> SimpleNtupleEoverPsingleParticle::SimpleNtupleEoverPsingleParticle::set met branches <<<" << std::endl;
  ...
  std::cout<< ">>>>>> SimpleNtupleEoverPsingleParticle::SimpleNtupleEoverPsingleParticle::set dielectron branches <<<" << std::endl;
  ...
  if(saveFbrem_)
  {
    std::cout<< ">>>>>> SimpleNtupleEoverPsingleParticle::SimpleNtupleEoverPsingleParticle::set fBrem branches <<<" << std::endl;
  ...
  if(saveMCPU_)
  {
    std::cout<< ">>>>>> SimpleNtupleEoverPsingleParticle::SimpleNtupleEoverPsingleParticle::set MC PU branches <<<" << std::endl;
  ...
  if(saveMCInfo_)
  {
    std::cout<< ">>>>>> SimpleNtupleEoverPsingleParticle::SimpleNtupleEoverPsingleParticle::set MC branches <<<" << std::endl;
  ...
  std::cout<< ">>>>>> SimpleNtupleEoverPsingleParticle::SimpleNtupleEoverPsingleParticle::get cluster corrections <<<" << std::endl;
  ...
  // if( jsonFlag_ == true )
  // {
  //   std::cout<< ">>>>>> SimpleNtupleEoverPsingleParticle::SimpleNtupleEoverPsingleParticle::read json file <<<" << std::endl;
  //   jsonMap_ = readJSONFile(jsonFileName_);
  // }
  
  std::cout<< ">>> SimpleNtupleEoverPsingleParticle::SimpleNtupleEoverPsingleParticle end <<<" << std::endl;
}
...
SimpleNtupleEoverPsingleParticle::~SimpleNtupleEoverPsingleParticle ()
{
  std::cout<< ">>> SimpleNtupleEoverPsingleParticle::~SimpleNtupleEoverPsingleParticle <<< analyzed " <<  eventNaiveId_ << " events" << std::endl;
  // save tree
  // outTree_ -> Write();
}
...
void SimpleNtupleEoverPsingleParticle::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  if( verbosity_ )
    std::cout<< ">>> SimpleNtupleEoverPsingleParticle::analyze begin <<<" << std::endl;
  ...
  ele1_recHit_ID.clear();
  ele1_recHit_E.clear();
  ele1_recHit_time.clear();
  ...
  ele2_recHit_ID.clear();
  ele2_recHit_E.clear();
  ele2_recHit_time.clear();
  ...
  ele_recHit_ID.clear();
  ele_recHit_E.clear();
  ele_recHit_time.clear();
  ele_recHit_flag.clear();
  ele_recHit_hashedIndex.clear();
  ele_recHit_ietaORix.clear();
  ele_recHit_iphiORiy.clear();
  ele_recHit_zside.clear();
  ele_recHit_laserCorrection.clear();
  ele_recHit_Alpha.clear();
  ele_recHit_ICConstant.clear();
  ele_nRecHits = -9999;
  ...
  */
  //C
  //  if(runId < 198022 || runId > 203742) return;
  //D
  //  if(runId < 203777 || runId > 208686) return;
  ...
  //************* MC PU
   ...
   if(saveMCInfo_) {
     ...
     eventType_ = 0;
     //     if(doWZSelection_) mcAnalysisZW_ = new MCDumperZW(genParticles, eventType_, verbosity_);
     //     else mcAnalysisSingleParticle_ = new MCDumper(genParticles, verbosity_);
     //     fillMCInfo(iEvent, iSetup);
   }

   if(verbosity_)
     std::cout << " particleIsEle_ = " << particleIsEle_ << std::endl;
  ...
  if ( nEle == 1 ) fillEleInfo ( iEvent, iSetup, 0, "ele1" );
  if ( nEle == 2 ) { 
    fillEleInfo ( iEvent, iSetup, 0, "ele1" ); 
    fillEleInfo ( iEvent, iSetup, 1, "ele2" );
  }
  
  if (nEle == 1 || nEle == 2) outTree_ -> Fill();
   }
   else{
     isPho = 1;
     //************* PHOTONS
     Handle<View<reco::Photon> > photonHandle;
     iEvent.getByLabel(PhoTag_,photonHandle);
     View<reco::Photon> photons = *photonHandle;
     
     int nPho = photons.size();
     if ( nPho == 1 ) fillEleInfo ( iEvent, iSetup, 0, "pho1");
     if ( nPho == 2 ) {
       fillEleInfo ( iEvent, iSetup, 0, "pho1" );
       fillEleInfo ( iEvent, iSetup, 1, "pho2" );
     }
     if (nPho==1 || nPho==2) outTree_ -> Fill();
   }
   
   
   if( verbosity_ )
     std::cout<< ">>> SimpleNtupleEoverPsingleParticle::analyze end <<<" << std::endl;
}



//-----------------------------------------------------------------------------------------
bool  SimpleNtupleEoverPsingleParticle::TightEle (const edm::Event & iEvent, const edm::EventSetup & iESetup, const int &iEle){
...
bool  SimpleNtupleEoverPsingleParticle::MediumEle (const edm::Event & iEvent, const edm::EventSetup & iESetup, const int &iEle){
...
// ----------------------------------------------------------------------------------------
bool SimpleNtupleEoverPsingleParticle::LooseEle (const edm::Event & iEvent, const edm::EventSetup & iESetup,const int &iEle){
...
bool SimpleNtupleEoverPsingleParticle::myWselection (const edm::Event & iEvent, const edm::EventSetup & iSetup)
{ 
  // default
...
bool SimpleNtupleEoverPsingleParticle::myZselection (const edm::Event & iEvent, const edm::EventSetup & iSetup)
{ 
...
void SimpleNtupleEoverPsingleParticle::fillPVInfo (const edm::Event & iEvent, const edm::EventSetup & iESetup){
...
//------------------------------------------------------------------------------------------------------------
void SimpleNtupleEoverPsingleParticle::fillRhoInfo(const edm::Event & iEvent, const edm::EventSetup & iSetup) 
{
...
void SimpleNtupleEoverPsingleParticle::fillEleInfo(const edm::Event & iEvent, const edm::EventSetup & iSetup, const int iEle, const std::string eleName)
{
  if( verbosity_ )
    std::cout<< ">>> SimpleNtupleEoverPsingleParticle::fillEleInfo start <<<" << std::endl;
  ...
  iEvent.getByLabel( reducedrecHitCollection_EB_, redrecHitsEB );
  const EcalRecHitCollection* theBarrelEcalRedRecHits = redrecHitsEB.product () ;
  if ( ! redrecHitsEB.isValid() ) {
    std::cerr << "SimpleNtupleEoverP::analyze --> redrecHitsEB not found" << std::endl;
  }
  //*********** EE REC HITS                                                                 
  edm::Handle<EcalRecHitCollection> redrecHitsEE;
  iEvent.getByLabel( reducedrecHitCollection_EE_, redrecHitsEE );
  const EcalRecHitCollection* theEndcapEcalRedRecHits = redrecHitsEE.product () ;
  if ( ! redrecHitsEE.isValid() ) {
    std::cerr << "SimpleNtupleEoverP::analyze --> redrecHitsEE not found" << std::endl;
  }
  //*********** ES REC HITS                                                                            
  edm::Handle<EcalRecHitCollection> redrecHitsES;
  iEvent.getByLabel( reducedrecHitCollection_ES_, redrecHitsES );
  const EcalRecHitCollection* theESEcalRedRecHits = redrecHitsES.product () ;
  std::cout << " theESEcalRedRecHits->size() =  " << theESEcalRedRecHits->size() << std::endl;
  ...
  //*********** ES REC HITS                                                                       
  edm::Handle<EcalRecHitCollection> recHitsES;
  iEvent.getByLabel( recHitCollection_ES_, recHitsES );
  const EcalRecHitCollection* theESEcalRecHits = recHitsES.product () ;
  std::cout << " theESEcalRecHits->size() =  " << theESEcalRecHits->size() << std::endl;
  if ( ! recHitsES.isValid() ) {
    std::cerr << "SimpleNtupleEoverP::analyze --> recHitsES not found" << std::endl;
  }
  ...
  if(verbosity_)
    std::cout << ">>> analyzr::particleIsEle_ = " << particleIsEle_ << std::endl;
  
  //************* ELECTRONS
  Handle<View<reco::GsfElectron> > electronHandle;
  View<reco::GsfElectron> electrons;
  if(particleIsEle_){
    iEvent.getByLabel(EleTag_,electronHandle);
    electrons = *electronHandle;
    if(verbosity_)
      std::cout << "  fillEle = ele" << std::endl;
  }

  //************* PHOTONS
  Handle<View<reco::Photon> > photonHandle;
  View<reco::Photon> photons;
  if(!particleIsEle_){
    iEvent.getByLabel(PhoTag_,photonHandle);
    photons = *photonHandle;
    if(verbosity_)
      std::cout << "  fillPho = pho" << std::endl;
  }
    ...
    if ( eleName == "ele1")
  {
    ...
    if( electron.isEB() ){
      E3x3 = EcalClusterTools::e3x3( *scRef, theBarrelEcalRedRecHits, topology);
    }
    if( electron.isEE() ){
      E3x3 = EcalClusterTools::e3x3( *scRef, theEndcapEcalRedRecHits, topology);
    }
    ...
    if(electron.isEB())
    {
      ...
      std::pair<DetId, float> id = EcalClusterTools::getMaximum(seedCluster->hitsAndFractions(), theBarrelEcalRedRecHits);
      
      // flag
      EcalRecHitCollection::const_iterator it = theBarrelEcalRedRecHits->find(id.first);
      
      if( it != theBarrelEcalRedRecHits->end() )
      {
    ...
    else
    {
      ...
      std::pair<DetId, float> id = EcalClusterTools::getMaximum(seedCluster->hitsAndFractions(), theEndcapEcalRedRecHits);
      
      // flag - OutOfTime
      EcalRecHitCollection::const_iterator it = theEndcapEcalRedRecHits->find(id.first);
      
      if( it != theEndcapEcalRedRecHits->end() )
      {
        const EcalRecHit& rh = (*it);
        energy = rh.energy();
    ...
    if(saveRecHitMatrix_)
    {
      ...
      if(electron.isEB())
      {
        DetId seedId = EcalClusterTools::getMaximum( scRef->hitsAndFractions(), theBarrelEcalRedRecHits ).first;    
	...
	for(std::vector<DetId>::const_iterator itr = rectangle.begin(); itr != rectangle.end(); ++itr)
        {
	  ++it;
           EcalRecHitCollection::const_iterator itrRecHit = theBarrelEcalRedRecHits->find(*itr) ;
          if(itrRecHit == theBarrelEcalRedRecHits->end()) continue;
      ...
      {
        DetId seedId = EcalClusterTools::getMaximum( scRef->hitsAndFractions(), theEndcapEcalRedRecHits ).first;    
	//save the matrix in case of eleSeed
	std::vector<DetId> rectangle =  EcalClusterTools::matrixDetId(topology, seedId, -9, 9, -9, 9);
	
	for(std::vector<DetId>::const_iterator itr = rectangle.begin(); itr != rectangle.end(); ++itr)
        {
          EcalRecHitCollection::const_iterator itrRecHit = theEndcapEcalRedRecHits->find(*itr) ;
          if(itrRecHit == theEndcapEcalRedRecHits->end()) continue;
    ...
    for(std::vector<std::pair<DetId,float> >::const_iterator rh = hits.begin(); rh!=hits.end(); ++rh)
    {
      ...
      {
        EBRecHitCollection::const_iterator itrechit = theBarrelEcalRedRecHits->find((*rh).first);
        if (itrechit==theBarrelEcalRedRecHits->end()) continue;
	...
	if( italpha != theEcalLaserAlphaMap->end() )
	  theAlpha = (*italpha);
        ...
        // fill recHit variables
	ele1_recHit_ID.push_back(0); // EB 
        ele1_recHit_E.push_back(itrechit->energy() * rhLaserCorrection);
	ele1_recHit_time.push_back(itrechit->time());
      ...
      {
        EERecHitCollection::const_iterator itrechit = theEndcapEcalRedRecHits->find((*rh).first);
        if (itrechit==theEndcapEcalRedRecHits->end()) continue;
  ...
  if ( eleName == "ele2" )
  {
	...
	if( italpha != theEcalLaserAlphaMap->end() )
	  theAlpha = (*italpha);
        ...
        // fill recHit variables
	ele2_recHit_ID.push_back(0); //EB                                
	ele2_recHit_E.push_back(itrechit->energy() * rhLaserCorrection);
	ele2_recHit_time.push_back(itrechit->time());
 ...
 /// add regression input variables
  ...
  // global recHit collections                                                            
  for(EcalRecHitCollection::const_iterator itr = theBarrelEcalRecHits->begin ();
      itr != theBarrelEcalRecHits->end (); ++itr){
    EBDetId ebid(itr->id());
    // fill recHit variables                                                            
    ele_recHit_ID.push_back(0); // EB                                                   
    ele_recHit_E.push_back(itr->energy());
    ele_recHit_time.push_back(itr->time());
    ele_recHit_flag.push_back(itr->recoFlag());
    ele_recHit_hashedIndex.push_back(ebid.hashedIndex());
    ele_recHit_ietaORix.push_back(ebid.ieta());
    ele_recHit_iphiORiy.push_back(ebid.iphi());
    ele_recHit_zside.push_back(ebid.zside());
  }
  for(EcalRecHitCollection::const_iterator itr = theEndcapEcalRecHits->begin ();
      itr != theEndcapEcalRecHits->end (); ++itr){
    EEDetId eeid(itr->id());
    // fill recHit variables                                                           
    ele_recHit_ID.push_back(1); // EB                                                  
    ele_recHit_E.push_back(itr->energy());
    ele_recHit_time.push_back(itr->time());
    ele_recHit_flag.push_back(itr->recoFlag());
    ele_recHit_hashedIndex.push_back(eeid.hashedIndex());
    ele_recHit_ietaORix.push_back(eeid.ix());
    ele_recHit_iphiORiy.push_back(eeid.iy());
    ele_recHit_zside.push_back(eeid.zside());
  }
  for(ESRecHitCollection::const_iterator itr = theESEcalRecHits->begin();
      itr != theESEcalRecHits->end(); ++itr){
    ESDetId preshId (itr->id ());
    // fill recHit variables                                                               
    ele_recHit_ID.push_back(2); // ES                                                      
    ele_recHit_E.push_back(itr->energy());
    ele_recHit_time.push_back(itr->time());
    ele_recHit_flag.push_back(itr->recoFlag());
    ele_recHit_hashedIndex.push_back(preshId.hashedIndex());
    ele_recHit_ietaORix.push_back(preshId.six());
    ele_recHit_iphiORiy.push_back(preshId.siy());
    ele_recHit_zside.push_back(preshId.zside());
  }


  }
  else if(!particleIsEle_) {
    reco::Photon electron = photons.at(iEle);
    if ( eleName == "pho1")
  {
 ...
 if( verbosity_ )
   std::cout<< ">>> SimpleNtupleEoverPsingleParticle::fillEleInfo end <<<" << std::endl;
}

// -----------------------------------------------------------------------------------------

 void SimpleNtupleEoverPsingleParticle::fillMetInfo(const edm::Event & iEvent, const edm::EventSetup & iSetup){
...
void SimpleNtupleEoverPsingleParticle::fillDoubleEleInfo(const edm::Event & iEvent, const edm::EventSetup & iSetup){
...
double SimpleNtupleEoverPsingleParticle::deltaPhi(const double& phi1, const double& phi2){ 
...
// -----------------------------------------------------------------------------------------
void SimpleNtupleEoverPsingleParticle::fillMCPUInfo (const edm::Event & iEvent, const edm::EventSetup & iSetup) 
{
...
// -----------------------------------------------------------------------------------------
/*
void SimpleNtupleEoverPsingleParticle::fillMCInfo (const edm::Event & iEvent, const edm::EventSetup & iESetup)
{
  //  std::cout << "SimpleNtupleEoverPsingleParticle::fillMCInfo" << std::endl; 

  if(doWZSelection_ && mcAnalysisZW_->isValid())
    {
      // Vboson Z 23  W +/-24
	...
	if(counter == 0 && (status == 1) && ( (abs(pdgId) == 11) || (abs(pdgId) == 22)) ) {
	  mcF1_fromV_E = pCurrent->p4().E();        
	  mcF1_fromV_Px = pCurrent->p4().Px();      
	  mcF1_fromV_Py = pCurrent->p4().Py();      
	  mcF1_fromV_Pz = pCurrent->p4().Pz();      
	  mcF1_fromV_Charge = pCurrent->charge();   
	  mcF1_fromV_PdgId = pCurrent->pdgId();     
	}
	if(counter == 1) {
	  mcF2_fromV_E = pCurrent->p4().E();        
	  mcF2_fromV_Px = pCurrent->p4().Px();      
	  mcF2_fromV_Py = pCurrent->p4().Py();      
	  mcF2_fromV_Pz = pCurrent->p4().Pz();      
	  mcF2_fromV_Charge = pCurrent->charge();   
	  mcF2_fromV_PdgId = pCurrent->pdgId();     
	}
      }
  }
}
...
//----------------------------------------------------------------------------------------------
DEFINE_FWK_MODULE(SimpleNtupleEoverPsingleParticle);
