#ifndef SimpleNtupleEoverPsingleParticle_h
#define SimpleNtupleEoverPsingleParticle_h
...
class SimpleNtupleEoverPsingleParticle : public edm::EDAnalyzer {
 
 public:

  explicit SimpleNtupleEoverPsingleParticle (const edm::ParameterSet&) ;
 ...
 protected:
  ...
  edm::InputTag reducedrecHitCollection_EB_;
  edm::InputTag reducedrecHitCollection_EE_;
  edm::InputTag reducedrecHitCollection_ES_;
  ...
  //  MCDumper*    mcAnalysisSingleParticle_;
  ...
  std::vector<int> ele1_recHit_ID;
  std::vector<float> ele1_recHit_E;
  std::vector<float> ele1_recHit_time;
 ...
 // ele2 variables  
  ...
  std::vector<int> ele2_recHit_ID;
  std::vector<float> ele2_recHit_E;
  std::vector<float> ele2_recHit_time;
 ...
 // Regression V3 variables
  ...
  std::vector<int> ele_recHit_ID;
  std::vector<float> ele_recHit_E;
  std::vector<float> ele_recHit_time;
  std::vector<int> ele_recHit_flag;
  std::vector<int> ele_recHit_hashedIndex;
  std::vector<int> ele_recHit_ietaORix;
  std::vector<int> ele_recHit_iphiORiy;
  std::vector<int> ele_recHit_zside;
  std::vector<float> ele_recHit_laserCorrection;
  std::vector<float> ele_recHit_Alpha;
  std::vector<float> ele_recHit_ICConstant;
  int   ele_nRecHits;
